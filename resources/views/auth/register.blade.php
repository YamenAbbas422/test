...
<div id="single-wrapper">
	<form  class="frm-single" method="POST" action="/registerto">
        @csrf
		<div class="inside">
			...
			<!-- /.frm-input -->
			<div class="frm-input"><input type="text" name="fname" placeholder="First Name" class="frm-inp"><i class="fa fa-user frm-ico"></i></div>
			<!-- /.frm-input -->
            <div class="frm-input"><input type="text" name="lname" placeholder="Last Name" class="frm-inp"><i class="fa fa-user frm-ico"></i></div>
			<!-- /.frm-input -->
            <div class="frm-input"><input type="text" name="mobile" placeholder="Mobile Phone" class="frm-inp"><i class="fa fa-mobile frm-ico"></i></div>
			<!-- /.frm-input -->
